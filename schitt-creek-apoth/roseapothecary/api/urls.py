...
urlpatterns = [
    ...
    path("customer-info/<uuid:pk>/", views.CustomerInfoRetrieveUpdateDestroy.as_view(), name="update_customer_info"),
    path("customer-orders/<uuid:pk>/", views.CustomerOrdersRetrieveUpdateDestroy.as_view(), name="update_customer_order"),
